...
if (user == null) {
    ...
    userDiv.addEventListener('click', (event)=>{
        if(event.target != logout){
            if(dropdownDiv.style.height != `${logout.offsetHeight}px`){
                dropdownDiv.style.height = `${logout.offsetHeight}px`
            } else{
    ...
    edit.addEventListener('click', () => {
        ...
        editTaskBtn.forEach((e) => {
            ...
            e.addEventListener('click', () => {
                ...
                console.log(e.parentElement.firstElementChild.dataset);
